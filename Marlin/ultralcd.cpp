//fichier a modifier pour affichage LCD
//ultralcd.cpp
...
//icare modification
//******************
char *ftostr3i(const float &x) //icare modification******************************************
{                              //***
  return itostr3i((int)x);     //***
}                              //***
